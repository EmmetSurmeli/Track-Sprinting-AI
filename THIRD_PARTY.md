...
`src/track_sprint/data/evidence.json` contains short original paraphrases of six linked research abstracts, with population, evidence type and limitations. It does not reproduce full papers. The VideoRun2D record is explicitly labeled as a workshop research preprint. Study results from OpenPose or adapted MoveNet are not claimed as validation of MediaPipe or this app.
